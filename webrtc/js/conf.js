...
var Conf = {
	...
	moveKeyRepeatTimeMs: 16,		// max. move key repeat time
	bombKeyRepeatTimeMs: 50,		// max. bomb key repeat time
	peerJsKey: 'peerjs',			// peer.js server key
	peerJsHost: location.hostname || 'localhost',	// peer.js server host
