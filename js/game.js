...
/**
 * Game class constructor. Create a new game with game mode <mode> of type GameMode*
 *
 * @param mode
 * @constructor
 */
...
GameClass.prototype.setup = function (playerManagerRef, p2pCommRef) {
    ...
    // set upo the view and the map
    this._view.set(MapDimensions.w, MapDimensions.h);
...
GameClass.prototype.startGame = function () {
    ...
    if(this._mode === GameModeSinglePlayer) {
        ...
        // set player1 controlds to arrow keys
        var player1Controls = new ControlClass();
